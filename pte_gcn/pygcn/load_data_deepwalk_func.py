...
def load_all_data(studydir, epi_txt, test_epi_txt, nonepi_txt, test_nonepi_txt, atlas_labels):
    ...
    gord_labels = atlas['parcel11'].squeeze()
    ...
    np.savez('/home/wenhuicu/ImagePTE-1/PTE_conn_f50.npz',
             conn_mat=conn_mat,
             deepwalk=dw_feat,
...
##============================================================================
    ...
    np.savez('/home/wenhuicu/ImagePTE-1/NONPTE_conn_f50.npz',
...
if __name__ == "__main__":
    ...
    if args.atlas == 'f50':
        atlas_labels = '/home/wenhuicu/atlases/functional/500sub_33n_deepwalk_32k_T7_L50R50_sigma0.5_nb9alpha0.5_km.mat'
    if args.atlas == 'f200':
        atlas_labels = '/home/wenhuicu/atlases/functional/500sub_33n_deepwalk_32k_T7_L200R200_sigma0.5_nb9alpha0.5_km.mat'
