...
def load_features(root_path, opt=0):
    ...
    f = np.load('/home/wenhuicu/data_npz/ADHD_parPearson_Lobes.npz') #'/home/wenhuicu/data_npz/TDC_parPearson_Lobes.npz' root_path + 'PTE_graphs_USCLobes.npz'
    conn_pte = f['conn_mat']
    # lab_ids = f['label_ids']
    # gordlab = f['labels']
    # sub_ids = f['sub_ids']
    ...
    f = np.load('/home/wenhuicu/data_npz/TDC_parPearson_Lobes.npz') #root_path + 'NONPTE_graphs_USCLobes.npz')
