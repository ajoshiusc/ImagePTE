...
parser.add_argument('--dataroot', type=str, default='../../../data_BG/noaug/', help='root directory of the dataset')
parser.add_argument('--fold', type=int, default=0, help='training which fold')
parser.add_argument('--lr', type=float, default=0.001, help='learning rate')
parser.add_argument('--stepsize', type=int, default=5, help='scheduler step size')
...
parser.add_argument('--iters', type=int, default=20, help='iterations of cross validation')
...
file_pos = "/home/wenhuicu/ImagePTE/pte_gcn/PRGNN/PTE_parPearson_HCP.npz"
file_neg = "/home/wenhuicu/ImagePTE/pte_gcn/PRGNN/NONPTE_parPearson_HCP.npz"
...
for i in range(opt.iters):
    ...
    for tr_index, val_index in kfold.split(x_features, labels):
        ...
        state_dict = torch.load('../../../models/ADHD_pretrain_245.pth')
