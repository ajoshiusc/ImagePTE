...
from utils.utils import normal_transform_train, normal_transform_test, train_val_test_split, boxcox_transform_train, boxcox_transform_test
...
parser.add_argument('--dataroot', type=str, default='data/noaug/', help='root directory of the dataset')
...
parser.add_argument('--rep', type=int, default=10, help='augmentation times')
...
ADHD_data = np.load(file_pos)
TDC_data = np.load(file_neg)
