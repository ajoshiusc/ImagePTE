...
cmd = (
    "~/Software/BrainSuite23a/svreg/bin/svreg_resample.sh "
    + stat_img_fname
    + " "
    + stat_img_fname.replace(".nii.gz", "_rsamp.nii.gz")
    + " -size 192 384 384 nearest"
)
...
bci2mni_map = (
    "/deneb_disk/icbm152/mni_icbm152_nlin_asym_09c/icbm152_t1.svreg.map.nii.gz"
)
...
plotting.plot_glass_brain(
    ...
    plot_abs=False,
    title="ALFF",
    output_file="/home/ajoshi/Desktop/alff_glassbrain_hbm2024.png",
)
plotting.show()
