...
def main():
    ...
    roi_ids = ni.load_img('/ImagePTE1/ajoshi/code_farm/svreg/USCBrainMulti/Brainnetome/BCI-Brainnetome.label.nii.gz').get_fdata()
    ...
    f_importances_atlas((clf.coef_).squeeze(), roi_ids=roi_ids,
                        atlasbasename='/ImagePTE1/ajoshi/code_farm/svreg/USCBrainMulti/Brainnetome/BCI-Brainnetome', outbase=outbase)
