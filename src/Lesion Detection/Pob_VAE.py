...
import scipy.signal
import VAE_model_pixel  as ProbVAE
...
#########################################
epoch=99
LM='/big_disk/akrami/git_repos_new/ImagePTE/src/Lesion Detection/models/VAE_final_prob_64'
        ...
        for i, data in enumerate(Validation_loader):
            ...
            if i < 20:
                ...
                comparison = torch.cat([
                    ...
                    torch.abs(f_data.view(batch_size, 1, 128, 128)[:n] -
                     f_recon_batch.view(batch_size, 1, 128, 128)[:n]),
                ...
                save_image(comparison.cpu(),
                           './models/VAE_final_prob_64/reconstruction_b' + str(i) + '.png',
                           nrow=n)
        #############save z values###############
            if i == 0:
